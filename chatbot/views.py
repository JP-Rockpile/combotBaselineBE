...
class ChatAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if conversation_index == 0:
            ...
            chat_response = self.conversation_index_1_response()
        ...
        return Response({"reply": chat_response, "index": conversation_index}, status=status.HTTP_200_OK)
    ...
    def conversation_index_1_response(self):
    ...
    def conversation_index_4_response(self, user_input):
        completion = client.chat.completions.create(
            model="gpt-4-turbo-preview",
            messages=[{"role": "assistant", "content": user_input}],
        )
